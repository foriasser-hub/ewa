 ...
 *
 * Extracted from page.tsx so the page itself can stay a Server Component
 * and wrap this form in <Suspense>. Without that boundary, useSearchParams
 * makes Next.js fail at static prerender time with:
